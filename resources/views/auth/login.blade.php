    ...
    <div class="container" id="login">
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="login">
                    <div class="logo">
                        <a href="{{ url('/') }}"><img src="{{ asset('uploads/logos/logo-dark.png') }}" alt="logo"></a>
                    </div>
                    <h1>Login</h1>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            <input id="mobile" type="number" class="form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{ old('mobile') }}" placeholder="Enter Mobile Number" required autocomplete="mobile" autofocus>
                        ...
                        <br>
                        <button type="submit" class="btn btn-lg btn-block btn-success">Login Now</button>
                    </form>
                    <div class="footer-text mb-2">
                        <label class="fw-bold reg-btn">Don't have an account? <a class="ml-2 site-text-primary" href="{{ route('register') }}">Register Now<a></label>
                    </div>
                    <!-- End Loging form -->
