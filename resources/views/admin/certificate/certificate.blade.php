...
<body>
    <div class="certificate-box">
        ...
        <div class="bottom-text">
            ...
            {{-- <p class="fs-6 course-type">The {{ $enroll->type->type_name }} of </p> --}}
            <p class="course-title"> <span class="course-type">The {{ $enroll->type->type_name }} of</span> {{ $enroll->category->category_name }}</p>
